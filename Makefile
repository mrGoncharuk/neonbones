...
INC_DIR = includes/
LIBFT_DIR = libft/
LIB = $(addprefix $(LIBFT_DIR), $(LIB_NAME)) -L./libsdl/lib -lSDL2
...
HEADERS = $(INC_DIR)neon.h $(LIBFT_DIR)libft.h libsdl/include/SDL2/SDL.h
...
INC = -I $(INC_DIR) -I $(LIBFT_DIR) -I libsdl/include/SDL2/
C_RED = \033[31m
C_GREEN = \033[32m
C_MAGENTA = \033[35m
C_NONE = \033[0m
